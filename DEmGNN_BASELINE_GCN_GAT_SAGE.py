...
class BaselineGNN(nn.Module):
    def __init__(self, node_features, gnn_out_features_half, gnn_dropout=args.gnn_dropout):
...
for run_id in range(NUM_RUNS):
    ...
    model = BaselineGNN(node_features=node_features_dim, gnn_out_features_half=args.gnn_out_features_half).to(device)
